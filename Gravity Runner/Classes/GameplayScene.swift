...
//  Gravity Runner
//
//  Created by Bryan Albert on 8/7/18.
...
class GameplayScene: SKScene, SKPhysicsContactDelegate {
    ...
    private func initializeGame() {
        ...
        Timer.scheduledTimer(timeInterval: 7, target: self, selector: #selector(GameplayScene.removeItems), userInfo: nil, repeats: true);
